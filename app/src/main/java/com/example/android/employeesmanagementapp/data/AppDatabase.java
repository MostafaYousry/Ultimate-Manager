                            ...
                            public void onCreate(SupportSQLiteDatabase db) {
                                ...
                                AppExecutor.getInstance().diskIO().execute(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        db.departmentsDao().addDepartment(new DepartmentEntry(1, "dep1", Calendar.getInstance(), "", false));
                                        db.departmentsDao().addDepartment(new DepartmentEntry(2, "dep2", Calendar.getInstance(), "", false));
                                        db.departmentsDao().addDepartment(new DepartmentEntry(3, "dep3", Calendar.getInstance(), "", false));
                                        db.departmentsDao().addDepartment(new DepartmentEntry(4, "dep4", Calendar.getInstance(), "", false));
                                        db.departmentsDao().addDepartment(new DepartmentEntry(5, "dep5", Calendar.getInstance(), "", false));
                                        db.departmentsDao().addDepartment(new DepartmentEntry(6, "dep6", Calendar.getInstance(), "", false));
                                        db.departmentsDao().addDepartment(new DepartmentEntry(7, "dep7", Calendar.getInstance(), "", false));
                                        ...
                                        db.employeesDao().addEmployee(new EmployeeEntry(4, 2, "amir", "swidan", "dfmnweifmw", 23, Calendar.getInstance(), "fef@gmail.com", "013232333", "rvmrivm", "", false));
                                        db.employeesDao().addEmployee(new EmployeeEntry(5, 2, "omar", "zawawi", "dfmnweifmw", 23, Calendar.getInstance(), "fef@gmail.com", "013232333", "rvmrivm", "", false));
                                        db.employeesDao().addEmployee(new EmployeeEntry(6, 3, "mohamed", null, "dfmnweifmw", 23, Calendar.getInstance(), "fef@gmail.com", "013232333", "rvmrivm", "", false));
                                        db.employeesDao().addEmployee(new EmployeeEntry(7, 4, "abdelrahman", "wael", "dfmnweifmw", 23, Calendar.getInstance(), "fef@gmail.com", "013232333", "rvmrivm", "", false));
                                        db.employeesDao().addEmployee(new EmployeeEntry(8, 5, "amr", "saleh", "dfmnweifmw", 23, Calendar.getInstance(), "fef@gmail.com", "013232333", "rvmrivm", "", false));
                                        db.employeesDao().addEmployee(new EmployeeEntry(9, 6, "hussein", null, "dfmnweifmw", 23, Calendar.getInstance(), "fef@gmail.com", "013232333", "rvmrivm", "", false));
                                        db.employeesDao().addEmployee(new EmployeeEntry(10, 6, "loay", "fakhr", "el din", 23, Calendar.getInstance(), "fef@gmail.com", "013232333", "rvmrivm", "", false));
                                        db.employeesDao().addEmployee(new EmployeeEntry(11, 7, "yamany", null, null, 23, Calendar.getInstance(), "fef@gmail.com", "013232333", "rvmrivm", "", false));
                                        db.employeesDao().addEmployee(new EmployeeEntry(12, 8, "ziad", "ashraf", "dfmnweifmw", 23, Calendar.getInstance(), "fef@gmail.com", "013232333", "rvmrivm", "", false));
                                        db.employeesDao().addEmployee(new EmployeeEntry(13, 9, "ramy", "essam", "dfmnweifmw", 23, Calendar.getInstance(), "fef@gmail.com", "013232333", "rvmrivm", "", false));
                                        db.employeesDao().addEmployee(new EmployeeEntry(14, 2, "zorba", "zanaty", "dfmnweifmw", 23, Calendar.getInstance(), "fef@gmail.com", "013232333", "rvmrivm", "", false));
